...
class PlayerCharacter(arcade.Sprite):
    ...
    def draw(self):
        ...
        healthbar_width = HEALTHBAR_WIDTH * 100
        healthbar_width_framework = HEALTHBAR_WIDTH * 100 + 4
        ...
        arcade.draw_rectangle_filled(center_x=self.center_x - HEALTHBAR_WIDTH * 0.5 * (100 - 100),
                                     center_y=self.top + 5,
